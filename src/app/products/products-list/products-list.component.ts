...
export class ProductsListComponent {
  ...
  ngOnInit(): void {
    ...
    this.productService.getProducts().subscribe((customers: any[]) => {
      ...
      const transformedCustomers = customers.map((customer: { id: string, name: string; fields: { productName: { stringValue: any; }; price: { stringValue: any; }; pack: { stringValue: any; }; productCode: { stringValue: any; }; vat: { stringValue: any; } }; }) => (
        {
